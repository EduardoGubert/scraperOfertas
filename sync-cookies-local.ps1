...
if (-not $containerRunning) {
    ...
    Write-Host "`n💡 Com o docker-compose.local.yml, os cookies JÁ ESTÃO compartilhados!" -ForegroundColor Green
    Write-Host "   Após iniciar o container, os cookies estarão disponíveis automaticamente." -ForegroundColor Green
    exit 0
}
